...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.enfermerium.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.enfermeria.update", [$enfermerium->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="fecha">{{ trans('cruds.enfermerium.fields.fecha') }}</label>
                <input class="form-control date {{ $errors->has('fecha') ? 'is-invalid' : '' }}" type="text" name="fecha" id="fecha" value="{{ old('fecha', $enfermerium->fecha) }}" required>
                @if($errors->has('fecha'))
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('hora_de_la_consulta') ? 'is-invalid' : '' }}" type="text" name="hora_de_la_consulta" id="hora_de_la_consulta" value="{{ old('hora_de_la_consulta', $enfermerium->hora_de_la_consulta) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('documento') ? 'is-invalid' : '' }}" type="number" name="documento" id="documento" value="{{ old('documento', $enfermerium->documento) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $enfermerium->nombre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grado') ? 'is-invalid' : '' }}" type="text" name="grado" id="grado" value="{{ old('grado', $enfermerium->grado) }}" required>
                @if($errors->has('grado'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('edad') ? 'is-invalid' : '' }}" type="number" name="edad" id="edad" value="{{ old('edad', $enfermerium->edad) }}" step="1" required>
                @if($errors->has('edad'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direccion') ? 'is-invalid' : '' }}" type="text" name="direccion" id="direccion" value="{{ old('direccion', $enfermerium->direccion) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eps') ? 'is-invalid' : '' }}" type="text" name="eps" id="eps" value="{{ old('eps', $enfermerium->eps) }}" required>
                @if($errors->has('eps'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grupo_sanguineo') ? 'is-invalid' : '' }}" type="text" name="grupo_sanguineo" id="grupo_sanguineo" value="{{ old('grupo_sanguineo', $enfermerium->grupo_sanguineo) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rh') ? 'is-invalid' : '' }}" type="text" name="rh" id="rh" value="{{ old('rh', $enfermerium->rh) }}" required>
                @if($errors->has('rh'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $enfermerium->telefono) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_del_padre') ? 'is-invalid' : '' }}" type="text" name="nombre_del_padre" id="nombre_del_padre" value="{{ old('nombre_del_padre', $enfermerium->nombre_del_padre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_de_la_madre') ? 'is-invalid' : '' }}" type="text" name="nombre_de_la_madre" id="nombre_de_la_madre" value="{{ old('nombre_de_la_madre', $enfermerium->nombre_de_la_madre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono_del_padre') ? 'is-invalid' : '' }}" type="number" name="telefono_del_padre" id="telefono_del_padre" value="{{ old('telefono_del_padre', $enfermerium->telefono_del_padre) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono_de_la_madre') ? 'is-invalid' : '' }}" type="number" name="telefono_de_la_madre" id="telefono_de_la_madre" value="{{ old('telefono_de_la_madre', $enfermerium->telefono_de_la_madre) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correo_del_padre') ? 'is-invalid' : '' }}" type="email" name="correo_del_padre" id="correo_del_padre" value="{{ old('correo_del_padre', $enfermerium->correo_del_padre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('correo_de_la_madre') ? 'is-invalid' : '' }}" type="email" name="correo_de_la_madre" id="correo_de_la_madre" value="{{ old('correo_de_la_madre', $enfermerium->correo_de_la_madre) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" name="descripcion" id="descripcion" required>{{ old('descripcion', $enfermerium->descripcion) }}</textarea>
            ...
            <div class="form-group">
                <label for="tratamiento">{{ trans('cruds.enfermerium.fields.tratamiento') }}</label>
                <textarea class="form-control {{ $errors->has('tratamiento') ? 'is-invalid' : '' }}" name="tratamiento" id="tratamiento">{{ old('tratamiento', $enfermerium->tratamiento) }}</textarea>
                @if($errors->has('tratamiento'))
                    <span class="text-danger">{{ $errors->first('tratamiento') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.enfermerium.fields.tratamiento_helper') }}</span>
            </div>
            <div class="form-group">
